...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/device_id/device_id.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/device_info/device_info.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/emoji_picker/emoji_picker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/file_picker/file_picker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_document_picker/flutter_document_picker.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/smart_bubble/smart_bubble.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/thumbnails/thumbnails.framework"
